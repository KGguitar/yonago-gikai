(() => {
  ...
  function renderCommitteeView(root, members) {
    root.innerHTML = "";
  ...
  function renderTermView(root, members) {
    root.innerHTML = "";
  ...
  function renderRoleView(root, members) {
    root.innerHTML = "";
  ...
  function renderKaihaView(root, members) {
    root.innerHTML = "";
